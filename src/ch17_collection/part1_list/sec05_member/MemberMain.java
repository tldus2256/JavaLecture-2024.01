package src.ch17_collection.part1_list.sec05_member;
...
public class MemberMain {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("성별이 남성인 멤버 리스트");
        // 성별이 남성인 멤버 리스트
        List<Member> mList2 = getMemberListByGender("남");
        mList2.forEach(x -> System.out.println(x));
